...
struct DocumentUploadView: View {
    ...
    @EnvironmentObject var router: AppRouter // Added AppRouter here
            ...
            VStack {
                ...
                Button {
                    ...
                    Text("Submit Application")
                        ...
                        .padding(.vertical, 16)
                        .background(viewModel.allDocumentsUploaded ? DS.primary : Color.secondary.opacity(0.3))
...
struct DocumentCardView: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            ZStack {
                Circle()
                    .fill(document.state == .completed ? Color(hex: "#00C48C").opacity(0.15) : DS.primaryLight)
...
struct CircularProgressView: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .stroke(DS.primaryLight, lineWidth: 4)
            Circle()
                .trim(from: 0, to: CGFloat(progress))
                .stroke(DS.primary, style: StrokeStyle(lineWidth: 4, lineCap: .round))
