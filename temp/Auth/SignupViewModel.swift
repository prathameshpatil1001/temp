...
public final class SignupViewModel: ObservableObject {
    ...
    /// Step 2: Verify both email and phone OTP codes. Returns `true` on successful verification.
    ...
    public func resendOTP() async {
        ...
        // In a real app, this would call authRepository.resendSignupOTP(registrationID)
