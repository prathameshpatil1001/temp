        ...
        HStack(spacing: 16) {
            ...
            VStack(spacing: 2) {
                Text(month)
                    ...
                    .padding(.vertical, 4)
                    .background(status == .paid ? Color(hex: "#00C48C") : Color.secondaryBlue)
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 10)
                    .stroke(status == .paid ? Color(hex: "#00C48C").opacity(0.3) : Color.secondaryBlue.opacity(0.3), lineWidth: 1)
            )
